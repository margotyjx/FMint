...
os.environ["TRANSFORMERS_CACHE"] = "/export/jyuan98/.cache"
...
def run_train():
	...
	if FLAGS.tfboard:
		# results_dir = f'/cmlscratch/margot98/learn2correct/save/{FLAGS.user}/results/{FLAGS.problem}/'+ stamp
		# results_dir = f'/export/users/song362/projects/in-context-operator-networks/icon-lm/save/{FLAGS.user}/results/{FLAGS.problem}/'+ stamp
		results_dir = f'/export/jyuan98/learn2correct/save/{FLAGS.user}/results/{FLAGS.problem}/'+ stamp
		
		if not os.path.exists(results_dir):
			os.makedirs(results_dir)
		file_writer = tf.summary.create_file_writer(results_dir)
		file_writer.set_as_default()
		# ckpt_dir = f'/cmlscratch/margot98/learn2correct/save/{FLAGS.user}/ckpts/{FLAGS.problem}/'+ stamp
		# ckpt_dir = f'/export/users/song362/projects/in-context-operator-networks/icon-lm/save/{FLAGS.user}/ckpts/{FLAGS.problem}/'+ stamp
		ckpt_dir = f'/export/jyuan98/learn2correct/save/{FLAGS.user}/ckpts/{FLAGS.problem}/'+ stamp
